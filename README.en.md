...
2. Select a video output path. The default path is **My Phone**.

3. Touch **Stop** to finish recording.

#### Playback

1. Place the recorded video file in **storage/media/100/local/files/Docs**, or click **Start** to record another video file (without audio).
...
#### Recording
##### UI Layer
1. On the **Index** page at the UI layer, touching **Record** triggers the file manager, allowing the user to select a path for storing the recorded file.
...
#### Playback
##### UI Layer
1. On the **Index** page at the UI layer, touching **Play** triggers a click event and the **selectFile()** method. This method invokes the file selection module of the file manager and obtains the file path selected by the user.
